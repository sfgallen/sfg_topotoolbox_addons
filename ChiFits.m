function Chi = ChiFits(S,DEM,A,varargin)
%
...
if length(outlets) > 1
    disp('Note: Your STREAMobj has more than 1 outlet. Using largest connected network...');
...
chi_var = cumtrapz(S,a.^Chi.mn_var(1));
...
[b,bint,k,rint,stats] = regress(zx-zb,CC,0.05);
Chi.ks_var = b(2)*a0^Chi.mn_var(1);
